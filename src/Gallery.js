      ...
      <div className="gallery ">
        <div className="row-grid ">
          <div className="col-9">
            <img
              src={Family}
              alt="Family therapy"
              className="img-fluid family-img mt-3"
            />
            ...
            <p className="therapy-description">
              ...
              leading to unhealthy relationships with our loved ones. This form
              of relational therapy encourages family members to unite and
          ...
          <div className="col-9">
            ...
            <p className="therapy-description">
              ...
              living in today's world. Alongside my extensive training in
              systemic and relational dynamics, I hold specialized
              qualifications in EMDR, Complex Trauma, Racial Trauma, and
        ...
        <div className="row">
          <div className="col-9">
            ...
            <p className="therapy-description">
              ...
              empeorarse. Soy una terapeuta completamente bilingüe y tengo 15
              años ayudando a mi comunidad a tener una vida mas plena y
              fortalecida. Tengo experiencia extensa y un interés particular en
              experiencias de conflicto familiar y de parejas, las perdidas por
              inmigración y trauma. También proveo un tratamiento terapéutico
              sensible a la diversidad cultural de nuestra comunidad Latina.
            </p>
            <BookNow />
          </div>
          <div className="col-9">
            ...
            <p className="therapy-description">
              ...
              receive support in their endeavors as they navigate the
              complexities of life. This type of therapy truly helps couples
              deepen their commitment to one another. It presents a valuable
              opportunity for partners to engage in open communication and to
              attentively listen to one another regarding challenges such as
              navigating dating, marriage, child-rearing, confronting issues
              during adolescence, dealing with infidelity, undergoing
              separation, or experiencing other significant moments together.{" "}
            </p>
            <BookNow />
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-9">
            ...
            <p className="therapy-description">
              I offer individual and group supervision to social workers and
              other mental health providers working in agencies, large
              institutions, and private practice. My background includes
              extensive experience receiving supervision from highly qualified
              faculty members specializing in family and systemic therapy.
              Additionally, I possess considerable experience in providing live
              individual and group supervision using a one-way mirror technique,
              as well as teaching at recognized institutions since 2014. Kindly
              inquire about a special rate if you register as a group comprising
              at least three clinicians from the same institution or if you are
